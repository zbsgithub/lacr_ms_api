...
public class AuthenticationInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest arg0, HttpServletResponse arg1, Object arg2) throws Exception {
    	...
    	//此处为不需要登录的接口放行
        if (arg0.getRequestURI().contains("/druid") || arg0.getRequestURI().contains("/rpc") || arg0.getRequestURI().contains("/swagger-ui.html") || 
      ...
      //判断请求信息
        ...
        try {
			...
			throw new RuntimeException("token不合法，请检查后再试。");
		}
        ...
        //判断Token过期
        boolean flag = JwtUtil.verify(headerToken, user.getUserName(), user.getPassword());
