...
public class SystemUsageUtil {
	...
	private static Logger logger = LoggerFactory.getLogger(SystemUsageUtil.class);
    ...
    public static double getMemoryUsage() {
        ...
        logger.info("getMemoryUsage available={},total={}", available, total);
    ...
    public static double getCpuUsage() {
        ...
        logger.info("getCpuUsage useRate={}", useRate);
